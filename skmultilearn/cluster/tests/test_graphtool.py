...
class GraphtoolClustererBaseTests(unittest.TestCase):
    ...
    def test_weight_is_not_bool_exception(self):
        self.assertRaises(ValueError, GraphToolCooccurenceClusterer, 'not bool', True)
    
    def test_allow_overlap_is_not_bool_exception(self):
        self.assertRaises(ValueError, GraphToolCooccurenceClusterer, True, 'not bool')
    ...
    def test_actually_works_on_proper_params(self):
        ...
        for allow_overlap in [True, False]:
            for weighted in [True, False]:
                clusterer = GraphToolCooccurenceClusterer(weighted = weighted, allow_overlap = allow_overlap)
